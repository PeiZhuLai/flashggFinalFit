...
# analysis = HZa
# process = GG2H
globalXSBRMap['HZa'] = od()
globalXSBRMap['HZa']['decay'] = {'mode':'constant','factor':1}
globalXSBRMap['HZa']['GG2H'] = {'mode':'constant','factor':0.1}
...
globalXSBRMap['STXS']['GG2H'] = {'mode':'ggH','factor':0.01} # PZ
